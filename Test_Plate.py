...
crack = np.array([[3, 5, 7, 5],
                  [5, 3, 5, 7],
                  [5-2/np.sqrt(2), 5-2/np.sqrt(2), 5+2/np.sqrt(2), 5+2/np.sqrt(2)],
                  [5+2/np.sqrt(2), 5-2/np.sqrt(2), 5-2/np.sqrt(2), 5+2/np.sqrt(2)]]).astype(float)
